...
class OpenAISummarizer():
    def __init__(self, api_key:str, model_name:str):
        ...
        self.llm = ChatOpenAI(base_url='https://api.openai.com/v1',model = self.model_name, temperature = self.temperature, api_key = self.api_key, max_retries=2, max_tokens=131072)
