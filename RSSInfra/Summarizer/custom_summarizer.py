...
class CustomSummarizer():
    def __init__(self, api_key:str, model_name:str):
        ...
        if self.api_url == None:
            self.api_url = os.environ.get("API_URL", "http://localhost:1234/v1")
        ...
        self.llm = ChatOpenAI(base_url=self.api_url,model = self.model_name, temperature = self.temperature, api_key = self.api_key, max_retries=2, max_tokens=131072)
